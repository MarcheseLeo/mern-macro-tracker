...
export const Profile = () => {
  ...
  const fullName =
    `${user?.firstName || ""} ${user?.lastName || ""}`.trim() || "Macro user";
  ...
  const handlePreferenceChange = async (key, value) => {
    if (key !== "notifications" && !preferences.notifications) {
      showFeedback(
        "info",
        "Enable notifications to manage reminder preferences.",
      );
      return;
    }
  ...
  const handleAvatarUpload = async (e) => {
    ...
    try {
      ...
      showFeedback(
        "danger",
        e.response?.data?.message || "Unable to upload this image.",
      );
    } finally {
  ...
  const handlePresetAvatar = async (avatar) => {
    ...
    try {
      ...
      showFeedback(
        "danger",
        e.response?.data?.message || "Unable to change avatar.",
      );
    } finally {
      setIsUploadingAvatar(false);
    }
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      showFeedback(
        "danger",
        e.response?.data?.message || "Unable to update your password.",
      );
    } finally {
  ...
  const goalCards = [
    ...
    },
    {
      ...
      unit: "g",
      tone: "primary",
      className: "profile-stat-card profile-macro-stat-card",
    },
    {
      icon: Scale,
  ...
  return (
    <div className="profile-page container py-3 pb-5">
      ...
      {feedback && (
        <div
          className={`alert alert-${feedback.type} profile-feedback-toast shadow-soft-lg small`}
          role="alert"
        >
          {feedback.message}
        </div>
          ...
          {goalCards.map((card) => (
            <div className="col-6" key={card.label}>
              <MetricTile
                ...
                unit={card.unit}
                tone={card.tone}
                className={card.className || "profile-stat-card"}
              />
            </div>
          ))}
        </div>
      ...
      >
        <div className={profileAccordionHeaderClass}>
          <div className={profileRowContentClass}>
            ...
            <div>
              <h3 className="fw-semibold small mb-0 mb-md-1 text-dark">
                Personal Info
              </h3>
              <p className="small text-muted-foreground mb-0 d-none d-md-block">
                Read and edit your account details.
              </p>
            </div>
          </div>
          <ChevronRight
            ...
            style={{
              transform:
                openSection === "info" ? "rotate(90deg)" : "rotate(0deg)",
            }}
          />
        </div>
          ...
          >
            <div className="row g-3 mt-3">
              <div className="col-12 col-md-6">
                <label className="form-label small fw-semibold text-secondary-foreground">
                  First name
                </label>
                <input
              ...
              <div className="col-12">
                ...
                <div className="input-group">
                  <span className="input-group-text profile-input-icon text-secondary-foreground">
                    <Mail size={16} />
                  </span>
                  <input
                    type="email"
              ...
              <div className="col-6 col-md-3">
                ...
                <input
                  ...
                  className="form-control profile-input"
                  name="dailyKcalGoal"
                  value={profileForm.dailyKcalGoal}
                  onChange={handleProfileChange}
                />
              </div>
              <div className="col-4">
            ...
            <button
              className="btn profile-primary-btn w-100 mt-3 d-flex align-items-center justify-content-center gap-2"
      ...
      >
        <div className={profileAccordionHeaderClass}>
          <div className={profileRowContentClass}>
            <span
              ...
              style={{
                backgroundColor:
                  "color-mix(in oklab, var(--fat) 10%, transparent)",
              }}
            >
            ...
            <div>
              ...
              <p className="small text-muted-foreground  mb-0 d-none d-md-block">
                Upload a photo or choose a generated avatar.
              </p>
            </div>
          </div>
          ...
          <ChevronRight
            ...
            style={{
              transform:
                openSection === "avatar" ? "rotate(90deg)" : "rotate(0deg)",
            }}
          />
        </div>
        ...
        {openSection === "avatar" && (
          <div
            className="d-grid gap-2 profile-avatar-grid mt-3"
            onClick={(e) => e.stopPropagation()}
          >
        ...
        <div className={profileAccordionHeaderClass}>
          <div className={profileRowContentClass}>
            <span
              ...
              style={{
                backgroundColor:
                  "color-mix(in oklab, var(--protein) 10%, transparent)",
              }}
            >
          ...
          <ChevronRight
            ...
            style={{
              transform:
                openSection === "password" ? "rotate(90deg)" : "rotate(0deg)",
            }}
          />
        </div>
          ...
          >
            <div className="d-flex flex-column gap-3 mt-3">
              <div>
                ...
                <div className="input-group">
                  <span className="input-group-text profile-input-icon">
                    <KeyRound size={16} />
                  </span>
                  <input
                    type="password"
            ...
            <button
              className="btn profile-secondary-btn w-100 mt-3 d-flex align-items-center justify-content-center gap-2"
      ...
      <section className="profile-card mb-4">
        <div className="d-flex align-items-center gap-3">
          <span
            ...
            style={{
              backgroundColor:
                "color-mix(in oklab, var(--water) 10%, transparent)",
            }}
          >
      ...
      {!preferences.notifications && (
        <p className="profile-preferences-hint small mb-3">
          Enable notifications to manage meal, water, achievement, and email
          preferences.
        </p>
      )}
      {preferenceItems.map((item) => (
        <PreferenceToggleCard
          ...
          disabled={item.key !== "notifications" && !preferences.notifications}
        />
      ))}
        ...
        <div className={profileRowClass}>
          <div className={profileRowContentClass}>
            <span
              ...
              style={{
                backgroundColor:
                  "color-mix(in oklab, var(--primary-muted) 10%, transparent)",
              }}
            >
              <Moon
                size={20}
                color="var(--primary-muted)"
                fill={`${isDark ? "var(--primary-muted)" : "color-mix(in oklab, var(--primary-muted) 10%, transparent)"}`}
              />
            </span>
...
const PreferenceToggleCard = ({
  ...
  return (
    <div
      className={`profile-card mb-4 ${disabled ? "profile-preference-disabled" : ""}`}
    >
      <div className={profileRowClass}>
        <div className={profileRowContentClass}>
          <span
            className="profile-section-icon"
            style={{
              backgroundColor: `color-mix(in oklab, ${item.color} 10%, transparent)`,
            }}
          >
          ...
          <div>
            ...
            {disabled && (
              <p className="profile-locked-copy mb-0">
