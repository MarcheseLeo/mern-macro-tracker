...
export const FoodDetailsView = ({ food, onConfirm }) => {
    ...
    return (
        <div className="d-flex flex-column h-100 a">
            ...
            {/* FULL MACRO TABLE */}
            <div className="flex-grow-1 overflow-y-auto mb-4">
                <h6 className="font-heading fw-bold mb-3 px-2">Nutritional Values</h6>
                <ul className="list-group list-group-flush border rounded-4 overflow-hidden">
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2 bg-light">
                        ...
                        <span className="fw-bold">{currentKcal} kcal</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2">
                        <span>Total Carbs</span>
                        <span className="fw-bold text-carbs">{calc(macros.carbs?.total)} g</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2 text-muted small ps-4">
                        <span>Sugars</span>
                        <span className='text-carbs-foreground'>{calc(macros.carbs?.sugars)} g</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2">
                        <span>Total Fat</span>
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2 text-muted small ps-4">
                        ...
                        <span className='text-fat-foreground'>{calc(macros.fats?.saturated)} g</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2">
                        <span>Protein</span>
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2">
                        <span>Fibers</span>
                        <span className="fw-bold">{calc(macros.fibers)} g</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center py-2">
                        <span>Salt</span>
                        <span className="fw-bold">{calc(macros.salt)} g</span>
                    </li>
                </ul>
            </div>
